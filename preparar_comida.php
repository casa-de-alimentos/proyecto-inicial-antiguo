...
$dataL = Almacen::getLastLogs('removed');
?>
...
<body>
  ...
  <main class="panelMain">
		<span class="panelTitle">Gasto de suministros</span>
					...
					<tbody>
						<?php
							...
							<tr>
								...
								<td>
									<span class="red-text">-<? echo $log['alm_stock'].$log['prod_medida']; ?></span>
								</td>
								<td>
									<? echo $log['alm_date'] ?>
								</td>
